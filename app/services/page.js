    ...
    return (
        <section className="py-12 relative">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mb-12">
                    <h2 className="font-manrope text-5xl  text-center font-bold text-blue-600 mb-4">Website Development Plans</h2>
                    <p className="text-gray-300 text-xl text-center leading-6">I will create mern stack website as mern stack developer
                    </p>
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                    ...
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            ...
                            <h3 className="font-manrope text-2xl font-bold py-2  text-center text-indigo-600">Basic MERN Stack Package</h3>
                            <div className="flex items-center justify-center">
                                <span className="font-manrope text-xl font-medium text-gray-900">PKR 18,427 |
                                </span>
                                <span className="text-xl line-through  ml-3 text-red-700">&nbsp;PKR 20,475</span>
                            </div>
                        </div>
                        {/* <!--List--> */}
                        ...
                        <a href="/contact" className="py-2.5 px-5 bg-indigo-50 shadow-sm rounded-full transition-all duration-500 text-base text-indigo-600 font-semibold text-center w-fit mx-auto group-hover:bg-indigo-600 group-hover:text-white ">Purchase Plan</a>
                        {/* <!--List End--> */}
                    </div>
                    {/* <!--Pricing Card--> */}
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            <div className="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-indigo-600">
                                ...
                                <svg className="w-6 h-6 text-indigo-600 transition-all duration-300 group-hover:text-white" viewBox="0 0 30 30" fill="none" xmlns="https://www.w3.org/2000/svg">
                            ...
                            <h3 className="font-manrope text-2xl font-bold  py-2 text-center text-indigo-600">Standard MERN Stack Package
                            </h3>
                            <div className="flex items-center justify-center">
                                <span className="font-manrope text-xl font-medium text-gray-900">PKR 55,281 |
                                </span>
                                <span className="text-xl line-through text-red-700 ml-3"> PKR 61,423
                    ...
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            <div className="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-indigo-600">
                                <svg className="w-6 h-6 text-indigo-600 transition-all duration-300 group-hover:text-white" viewBox="0 0 31 30" fill="none" xmlns="https://www.w3.org/2000/svg">
                            ...
                            <h3 className="font-manrope text-2xl font-bold py-2  text-center text-indigo-600">Premium MERN Stack Package</h3>
                            <div className="flex items-center justify-center">
                                <span className="font-manrope text-xl font-medium text-gray-900">PKR 92,134 |
                                </span>
                                <span className="text-xl line-through text-red-700 ml-3"> PKR 102,371
