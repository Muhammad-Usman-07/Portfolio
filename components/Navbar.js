        ...
        <nav className="bg-gray-900 border-gray-800">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2"> {/* Reduced padding */}
                <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    {/* <span className="self-center text-4xl font-semibold text-white font-serif">Portfolio</span> */}
                </a>
                <div className="flex flex-col relative items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    >
                        ...
                        <img className="w-10 h-10 rounded-full" src="usman.png" alt="user photo" /> {/* Reduced icon size */}
                    </button>
                    <div
                        className={`${dropdownOpen ? "" : "hidden"
                            } mt-2 absolute  right-0 z-50 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}
                        id="user-dropdown"
                        style={{ top: "100%", right: "0" }}
                    >
                        <div className="px-4 py-3">
                            <span className="block text-sm text-gray-900 dark:text-white">Muhammad Usman</span>
                            <span className="block text-sm text-gray-500 truncate dark:text-gray-400"><a href="/contact">digitalusman@gmail.com</a></span>
                        </div>
